...
public class ArticleContent {
    ...
    public void updateArticle(ArticleContent articleContent) {
        ...
        description = articleContent.getDescription().isEmpty() ? description : articleContent.getDescription();
    ...
    public boolean equals(Object o) {
        ...
        return title.equals(that.title) && description.equals(that.description) && body.equals(that.body);
    }
